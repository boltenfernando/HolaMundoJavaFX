...
public class ClienteController {
    ...
    private void exportarCsv(File file) { /* tu lógica existente */ }
    private void importarCsv(File file) { /* tu lógica existente */ }
    ...
    public void mostrarFormularioModal(Cliente cliente) { /* tu lógica existente */ }
    public void mostrarDetalle(Cliente cliente) { /* tu lógica existente */ }
